...
<a href="{{ route('proveedores.show', $id) }}" class='btn btn-default btn-xs' data-toggle="tooltip" title="Ver">
    <i class="glyphicon glyphicon-eye-open"></i>
</a>

<a href="{{ route('proveedores.edit', $id) }}" class='btn btn-info btn-xs' data-toggle="tooltip" title="Editar">
