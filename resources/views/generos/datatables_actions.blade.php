...
<a href="{{ route('generos.show', $id) }}" class='btn btn-default btn-xs' data-toggle="tooltip" title="Ver">
    <i class="glyphicon glyphicon-eye-open"></i>
</a>

<a href="{{ route('generos.edit', $id) }}" class='btn btn-info btn-xs' data-toggle="tooltip" title="Editar">
...
<div class="modal fade modal-warning" id="modal-delete-{{$id}}" tabindex='-1'>
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['route' => ['generos.destroy', $id], 'method' => 'delete']) !!}
