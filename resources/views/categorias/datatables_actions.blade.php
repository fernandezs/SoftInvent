...
<a href="{{ route('categorias.show', $id) }}" class='btn btn-default btn-xs' data-toggle="tooltip" title="Ver">
    <i class="glyphicon glyphicon-eye-open"></i>
</a>

<a href="{{ route('categorias.edit', $id) }}" class='btn btn-info btn-xs' data-toggle="tooltip" title="Editar">
