...
class ProveedorAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($proveedors->toArray(), 'Proveedors recuperado con éxito');
    }
    ...
    public function update($id, UpdateProveedorAPIRequest $request)
    {
        ...
        return $this->sendResponse($proveedor->toArray(), 'Proveedor actualizado exitosamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Proveedor eliminado exitosamente');
    }
}
